          ...
          <div className=' flex flex-col w-[30rem]   bg-[#101935] border-[1px] border-[#6c71ff37] rounded-md px-[2.5rem] py-[2.5rem] ' >
            ...
            <form onSubmit={(e) => handleUserLogin(e)} className=' flex flex-col gap-[1rem]   '  >
              <div className=' flex flex-col gap-[.5rem] ' >
                ...
                <input onChange={(e) => setEmail(e.target.value)} className=' bg-[#8C8C9A1F] text-[#AEB9E180] px-[1rem] py-[.5rem] rounded-md outline-none focus:outline-[#6c71ff5c] ' type="text" id="email" name="email" placeholder="Enter your Email " />
              </div>
              <div className=' flex flex-col gap-[.5rem] ' >
              ...
              <button className={`   ${email && pass ? "opacity-100" : "opacity-25"} bg-[#6C72FF] text-white px-[.5rem] py-[.5rem] rounded-md mt-[1rem] `} >Login</button>
            ...
            <button onClick={handleGoogleLogin} className=' bg-[#e2eaf8] flex justify-center items-center gap-[.5rem] px-[.5rem] py-[.5rem] rounded-md font-nunito font-[600] text-[1.02rem] mt-[2rem]   ' >
