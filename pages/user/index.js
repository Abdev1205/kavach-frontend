                ...
                <div className='  flex flex-col gap-[2rem] w-[100%]  h-[100%] ' >
                  {
                    feed && feed.map((data, index) => {
                      return (
                        <SocialMediaCard key={index} data={data} />
                      )
                    })
                  }
                  <div onClick={() => setCreatePost(true)} className=' post-social-button cursor-pointer active:scale-95 duration-300 shadow-md sticky bottom-[.5rem] left-[98%] flex justify-center items-center z-[10] bg-[#6C72FF] text-white w-[4rem] py-[1rem]    ' >
              ...
              <div className=' flex flex-col w-[30%] gap-[1rem]   ' >
                ...
                <div className=' bg-[#101935] border-[1px] border-[#191F35] px-[1rem] py-[.9rem] w-[100%] h-[38.8vh] rounded-md flex flex-col gap-[.4rem]  ' >
                  <div className=' flex justify-between items-center  ' >
                    <h2 className=' text-[#6C72FF] text-[1.03rem] ' >News Around you</h2>
                    <button onClick={() => setCreateNews(true)} className=' active:scale-95 bg-[#6C72FF] text-[.8rem] text-white flex justify-center items-center w-[3.5rem] gap-[.3rem] h-[1.2rem] rounded-sm ' >
                      <MdAdd />
                      Add
                    </button>
                  </div>
                ...
                <div className=' bg-[#101935] border-[1px] border-[#191F35] px-[1rem] py-[.9rem] w-[100%] h-[38.8vh] rounded-md flex flex-col gap-[.4rem]  ' >
                  <div className=' flex justify-between items-center  ' >
                    <h2 className=' text-[#6C72FF] text-[1.03rem] ' >Trending Around you</h2>
                  ...
                  <div className=' flex w-[100%] flex-col gap-[.8rem] h-[32vh] overflow-auto ' >
                    {trendingData && trendingData.map((data, index) => {
                      return (
