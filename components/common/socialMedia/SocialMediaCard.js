...
const SocialMediaCard = ({ data, }) => {
  ...
  return (
    <div className=' cursor-pointer bg-[#101935] border-[2px] border-[#191F35] rounded-md w-[100%] h-[28rem] py-[.6rem] flex flex-col gap-[.5rem] ' >
      <SharePost
        visible={shareModel}
      ...
      <div className=' w-[100%] h-[20rem] ' >
        <Link href={`/police/social/${data.id}`} >
          <Image
            src={data.postImage}
            width={1000}
            height={1000}
